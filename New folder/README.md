...
> **AI-Based Video Automation System** | Python, Whisper (ASR), YOLO (CV), CLIP, FFmpeg | Sep 2025 – Nov 2025  
> Built an AI-driven automation pipeline integrating speech recognition, computer vision, and semantic scene analysis for intelligent best-moment detection and auto-subtitling. Reduced manual content creation effort by ~95% through end-to-end workflow automation. Supports any video language, dual/multi-audio tracks, and outputs 9:16 vertical shorts with word-level animated captions compatible with TikTok, YouTube Shorts, and Instagram Reels.
