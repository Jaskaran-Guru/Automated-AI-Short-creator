"""
modules/audio_extractor.py — Detect and extract audio tracks using FFprobe/FFmpeg
Supports multi-track / dual-audio videos. Lets user pick a track or auto-selects.
"""
...
def select_audio_track(tracks: List[Dict], interactive: bool = True) -> Optional[int]:
    ...
    """
    if not tracks:
        raise ValueError("Critical Error: The uploaded video contains no audio tracks. VIRAIL requires an audio stream for Whisper transcription and energy analysis.")
