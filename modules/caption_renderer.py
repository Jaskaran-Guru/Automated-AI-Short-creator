"""
modules/caption_renderer.py — Burn ASS animated captions onto a clip using FFmpeg.
Handles per-word karaoke-style highlighting baked into the video stream.
"""
